...
data_ip="https://raw.githubusercontent.com/ndhet/permission/main/seler"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/ndhet/permission/main/"
...
REPO="https://github.com/ndhet/permission.git"
...
#edit link https://justpaste.it/edit/62611923/jvkpgifwvqum13le
    ...
    git remote add origin https://github.com/ndhet/permission
    git push -f https://${TOKEN}@github.com/ndhet/permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
