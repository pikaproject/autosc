...
ipsaya=$(curl -s -4 ipv4.icanhazip.com)
...
Exp=$(curl -sS https://raw.githubusercontent.com/ndhet/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
Exp2=$(curl -sS https://raw.githubusercontent.com/ndhet/permission/main/ip | grep $MYIP | awk '{print $3}')
...
# DNS PATCH
#tipeos2=$(uname -m)
Name2=$(curl -sS https://raw.githubusercontent.com/ndhet/permission/main/ip | grep $MYIP | awk '{print $2}')
# GETTING DOMAIN NAME
